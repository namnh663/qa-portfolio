    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8" role="main">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full lg:w-80 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 
          ...
          {error && (
            <div className="bg-red-50 dark:bg-red-900/50 border-l-4 border-red-500 p-4 mb-6 rounded-lg"
              role="alert"
              aria-live="polite">
                ...
                {filteredUsers.map(user => (
                  <div
                    ...
                    className={`${viewMode === 'grid'
                        ...
                        : 'border-b dark:border-gray-700 pb-4'
                      } p-4`}
                  >
                    <div className={`flex ${viewMode === 'grid' ? 'flex-col items-center' : 'items-center'} gap-4`}>
                      <img
                        ...
                        className={`${viewMode === 'grid' ? 'w-24 h-24' : 'w-16 h-16'
                      ...
                      <Button
                        ...
                        variant="primary"
                        className={`${viewMode === 'grid' ? 'w-full mt-4' : ''} transform hover:scale-105 transition-transform duration-150`}
                      >
                        View Profile
                      </Button>
                    </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full m-4 transform transition-all">
                <div className="p-6">
                  <div className="flex justify-between items-start mb-6">
                    <h2 id="profile-title" className="text-2xl font-bold text-gray-900 dark:text-white">
